package com.lzscoding.demozookeeper.aspectj;


import com.lzscoding.demozookeeper.annotation.LockKeyParam;
...
public class ZooLockAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(com.lzscoding.demozookeeper.annotation.ZooLock)")
    public void doLock() {
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        try {
            // 假设上锁成功，以后拿到的都是 false.lock.acquire()
